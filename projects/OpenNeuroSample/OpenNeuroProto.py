...
class OpenNeuroOverview(object):
    def __init__(self):
        self.archive_path = "/Users/cocozhao/Documents/GitHub/rt-cloud/projects/OpenNeuroSample/"  # the path to archive
...
class DownloadOpenNeuroDataset(object):
    def __init__(self, accession_number):
        ...
        self.subject = None
        self.rootpath = "/Users/cocozhao/Documents/GitHub/rt-cloud/projects/OpenNeuroSample/" # the default path. "" is saved for the path to BIDSArchive
    ...
    def write_conf(self):
        print(self.default_destination)
        shutil.copy(self.rootpath + 'open_neuro.toml', self.default_destination)
